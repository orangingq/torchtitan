...
for PP_SCHEDULER in GPipe 1F1B Interleaved1F1B ZBVZeroBubble ; do # GPipe 1F1B Interleaved1F1B  InterleavedZeroBubble ZBVZeroBubble
    for METRIC_TYPE in fullrand7 apf nofreeze auto timelyapf timelyauto ; do #nofreeze apf auto fullrand7 timelyapf timelyauto 
