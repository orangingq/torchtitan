...
BASENAME_LIST=( # You can expand this list as needed
  ...
  # "1029_GPipe_apf_dm1"
  # "1029_GPipe_fullrand7_dm1"
  # "1030_GPipe_auto_dm1"
  # "1029_GPipe_timelyapf_dm1"
  # "1029_GPipe_timelyauto_dm1"
  "1031_1F1B_nofreeze_dm1"
  # "1029_1F1B_apf_dm1"
  # "1029_1F1B_fullrand7_dm1"
  # "1030_1F1B_auto_dm1"
  # "1029_1F1B_timelyapf_dm1"
  # "1029_1F1B_timelyauto_dm1"
  "1031_Interleaved1F1B_nofreeze_dm1"
  # "1029_Interleaved1F1B_apf_dm1"
  # "1029_Interleaved1F1B_fullrand7_dm1"
  # "1030_Interleaved1F1B_auto_dm1"
  # "1029_Interleaved1F1B_timelyapf_dm1"
  # "1029_Interleaved1F1B_timelyauto_dm1"
) 
